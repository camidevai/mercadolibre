...
export default function Home() {
  const offersTrack = useRef<HTMLDivElement>(null);
  const moveOffers = (direction: number) => { const track = offersTrack.current; if (track) track.scrollBy({ left: direction * track.clientWidth * 0.85, behavior: 'auto' }); };
  ...
  return (
    <main>
      ...
      <section className="deals-spotlight" id="inicio" aria-labelledby="spotlight-title"><div className="spotlight-heading"><div><span className="eyebrow dark">LA SELECCIÓN DE CAMIDEVAI</span><h1 id="spotlight-title">Buenas ofertas.<br/><em>Grandes descubrimientos.</em></h1><p>Tecnología y productos que vale la pena mirar. Encuentra tu próximo favorito.</p></div><a className="offers-primary-button" href="#ofertas">Ver ofertas <span aria-hidden="true">↗</span></a></div><div className="spotlight-toolbar"><span>Un vistazo a mis recomendados</span><div><button type="button" className="spotlight-prev" onClick={() => moveOffers(-1)} aria-label="Ofertas anteriores" aria-controls="spotlight-track">←</button><button type="button" className="spotlight-next" onClick={() => moveOffers(1)} aria-label="Más ofertas" aria-controls="spotlight-track">→</button></div></div><div className="spotlight-track" id="spotlight-track" ref={offersTrack} role="region" aria-label="Carrusel de ofertas destacadas" tabIndex="0"><a className="spotlight-card" href="#ofertas"><div className="spotlight-image"><img src="/products/airpods-4-anc.png" alt="Apple AirPods 4 con Cancelación Activa de Ruido — Distribuidor Autorizado" width="260" height="180" /><span>-17%</span></div><div className="spotlight-details"><small>Apple / Audio</small><h3>Apple AirPods 4 con Cancelación Activa de Ruido</h3><del>$249.990</del><strong>$205.815</strong><b>Explorar ofertas ↗</b></div></a><a className="spotlight-card" href="#ofertas"><div className="spotlight-image"><img src="/products/iphone-15-128-azul.jpg" alt="Apple iPhone 15 (128 GB) — Azul — Distribuidor Autorizado" width="260" height="180" /><span>-20%</span></div><div className="spotlight-details"><small>Apple / iPhone</small><h3>Apple iPhone 15 (128 GB) — Azul</h3><del>$899.990</del><strong>$719.032</strong><b>Explorar ofertas ↗</b></div></a><a className="spotlight-card" href="#ofertas"><div className="spotlight-image"><img src="/products/airpods-max-2.jpg" alt="AirPods Max 2 — Naranja — Distribuidor Autorizado" width="260" height="180" /><span>-10%</span></div><div className="spotlight-details"><small>Apple / Audio</small><h3>AirPods Max 2 — Naranja — Distribuidor Autorizado</h3><del>$649.990</del><strong>$584.911</strong><b>Explorar ofertas ↗</b></div></a><a className="spotlight-card" href="#ofertas"><div className="spotlight-image"><img src="/products/beats-solo-buds.jpg" alt="Audífonos Beats Solo Buds Inalámbricos — Morado Ártico" width="260" height="180" /><span>-15%</span></div><div className="spotlight-details"><small>Beats / Audio</small><h3>Audífonos Beats Solo Buds Inalámbricos — Morado Ártico</h3><del>$99.990</del><strong>$84.490</strong><b>Explorar ofertas ↗</b></div></a><a className="spotlight-card" href="#ofertas"><div className="spotlight-image"><img src="/products/airpods-pro-3.jpg" alt="Apple AirPods Pro 3 Blanco con Cancelación de Ruido — Distribuidor Autorizado" width="260" height="180" /><span>-8%</span></div><div className="spotlight-details"><small>Apple / Audio</small><h3>Apple AirPods Pro 3 Blanco con Cancelación de Ruido — Distribuidor Autorizado</h3><del>$299.990</del><strong>$274.330</strong><b>Explorar ofertas ↗</b></div></a><a className="spotlight-card" href="#ofertas"><div className="spotlight-image"><img src="/products/iphone-16-128-negro.jpg" alt="Apple iPhone 16 (128 GB) — Negro — Distribuidor Autorizado" width="260" height="180" /><span>-15%</span></div><div className="spotlight-details"><small>Apple / iPhone</small><h3>Apple iPhone 16 (128 GB) — Negro</h3><del>$949.990</del><strong>$799.990</strong><b>Explorar ofertas ↗</b></div></a></div><p className="spotlight-note">Precios referenciales en pesos chilenos, sujetos a cambios. Confirma el precio final en Mercado Libre.</p></section>
<section className="hero brand-hero brand-hero-no-photo" id="sobre-cami"><div className="hero-copy"><span className="eyebrow"><i></i> CAMILA BAÑARES · CAMIDEVAI</span><h2>La IA se entiende.<br/>Las ideas se<br/><em>hacen realidad.</em></h2><p>Soy ingeniera en Informática, creadora de contenido y divulgadora tecnológica. Te ayudo a entender la inteligencia artificial y a encontrar cómo aplicarla en tu trabajo, tu contenido y tu negocio.</p><div className="hero-actions"><a className="offers-primary-button" href="#ofertas">Ver ofertas <span aria-hidden="true">↗</span></a><a className="hero-secondary-link" href="#caminos">Descubre lo que podemos crear →</a></div><div className="expertise-line"><span>Informática</span><span>Formación en ciberseguridad</span><span>Postgrado en IA</span></div></div></section><div className="editorial-strip"><span>INTELIGENCIA ARTIFICIAL</span><b>✳</b><span>CREATIVIDAD</span><b>✳</b><span>TECNOLOGÍA APLICADA</span><b>✳</b><span>COMUNIDAD</span></div>
<section className="brand-paths brand-section" id="caminos"><div className="section-heading"><div><span className="eyebrow dark">ELIGE POR DÓNDE EMPEZAR</span><h2>¿Qué quieres hacer hoy?</h2></div></div><div className="path-grid"><a href="#aprender"><span>01 / APRENDER</span><h3>Entender la IA<br/>y usarla mejor.</h3><p>Ideas prácticas para tu trabajo y tu contenido.</p><b>Explorar ↗</b></a><a href="#negocios"><span>02 / CONSTRUIR</span><h3>Darle forma digital<br/>a tu negocio.</h3><p>Páginas web, asesorías y automatización.</p><b>Ver servicios ↗</b></a><a href="#colaboraciones"><span>03 / COLABORAR</span><h3>Acercar tu marca<br/>a las personas.</h3><p>Videos para marcas, demostraciones y charlas.</p><b>Trabajemos juntos ↗</b></a></div></section>
